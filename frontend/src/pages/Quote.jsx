...
export default function Quote() {
  ...
  return (
    <>
      ...
      <section className="section-pad-sm bg-white/80 backdrop-blur-sm border-b border-slate-100">
        <div className="container-page w-full max-w-4xl">
          <QuoteWorkflow />
        </div>
      </section>

      <section className="section-pad-sm">
        <div className="container-page w-full max-w-2xl">
